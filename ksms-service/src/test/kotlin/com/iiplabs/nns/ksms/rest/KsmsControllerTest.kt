...
import com.iiplabs.nns.ksms.KsmsServiceApplication
...
import com.iiplabs.nns.ksms.model.SendMessageStatus
...
@ActiveProfiles("test")
@SpringBootTest(classes = arrayOf(KsmsServiceApplication::class),
    webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
class KsmsControllerTest {
